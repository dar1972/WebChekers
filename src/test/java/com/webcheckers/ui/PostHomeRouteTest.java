...
public class PostHomeRouteTest {
    ...
    public void new_session() {
        ...
        //   * in the session.
        verify(session).attribute(eq(PostHomeRoute.USER_PARAM), any(PlayerLobby.class));
        verify(session).attribute(eq(PostHomeRoute.OPPONENT_PARAM), any(PlayerLobby.class));
    }
